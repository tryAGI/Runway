...
internal static partial class StartGeneratingCreateVoiceIsolationCommandApiCommand
{
        ...
        name: @"--x-runway-version")
    {
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Runway.CreateVoiceIsolationResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Runway.CreateVoiceIsolationResponse value, ref string? text);
...
This endpoint will start a new task to isolate the voice from the background audio. Audio duration must be greater than 4.6 seconds and less than 3600 seconds.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::Runway.CreateVoiceIsolationRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
