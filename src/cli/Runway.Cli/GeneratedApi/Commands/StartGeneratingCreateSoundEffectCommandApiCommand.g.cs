...
internal static partial class StartGeneratingCreateSoundEffectCommandApiCommand
{
        ...
        name: @"--x-runway-version")
    {
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Runway.CreateSoundEffectResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Runway.CreateSoundEffectResponse value, ref string? text);
...
This endpoint will start a new task to generate sound effects from a text description.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::Runway.CreateSoundEffectRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
