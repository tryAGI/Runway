...
internal static partial class ModelRouterGetRoutersCommandApiCommand
{
        ...
        name: @"--x-runway-version")
    {
        ...
        DefaultValueFactory = _ => "2024-11-06",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Runway.GetRoutersResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Runway.GetRoutersResponse value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ModelRouter.GetRoutersAsync(
                                    cursor: cursor,
                                    limit: limit,
