...
internal static partial class TaskManagementGetTasksByIdCommandApiCommand
{
        ...
        name: @"--x-runway-version")
    {
        ...
        DefaultValueFactory = _ => "2024-11-06",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Runway.GetTasksResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Runway.GetTasksResponse value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.TaskManagement.GetTasksByIdAsync(
                                    id: id,
