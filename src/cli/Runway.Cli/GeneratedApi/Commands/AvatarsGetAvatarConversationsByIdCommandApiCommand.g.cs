...
internal static partial class AvatarsGetAvatarConversationsByIdCommandApiCommand
{
    private static Argument<global::System.Guid> Id { get; } = new(
        name: @"id")
    {
        Description = @"The conversation ID. This is the same value as the realtime session ID for the call.",
    };
        ...
        name: @"--x-runway-version")
    {
        ...
        DefaultValueFactory = _ => "2024-11-06",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Runway.GetAvatarConversationsResponse2 value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Runway.GetAvatarConversationsResponse2 value, ref string? text);
