...
internal static partial class StartGeneratingCreateVideoToVideoCommandApiCommand
{
        ...
        name: @"--x-runway-version")
    {
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Runway.CreateVideoToVideoResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Runway.CreateVideoToVideoResponse value, ref string? text);
...
This endpoint will start a new task to generate a video from a video.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::Runway.CreateVideoToVideoRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
