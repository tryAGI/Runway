...
internal static partial class StartGeneratingCreateImageToVideoCommandApiCommand
{
        ...
        name: @"--x-runway-version")
    {
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Runway.CreateImageToVideoResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Runway.CreateImageToVideoResponse value, ref string? text);
...
This endpoint will start a new task to generate a video from an image.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::Runway.CreateImageToVideoRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
