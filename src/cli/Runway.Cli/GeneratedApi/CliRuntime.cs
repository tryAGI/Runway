...
namespace Runway.Cli.GeneratedApi;

internal static class CliRuntime
{
    private const string UserSecretsId = "Runway.Cli";
    private const string UserSecretApiKeyName = "RUNWAY_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"RUNWAY_API_KEY", @"RUNWAYML_API_SECRET"];
    private const string CredentialFileDirectoryName = "";

    public static async global::System.Threading.Tasks.Task<global::Runway.RunwayClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Runway.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Runway.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Runway.RunwayClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Runway.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Runway.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Runway.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Runway.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("RUNWAY_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Runway.ApiException exception)
    {
        var builder = new StringBuilder();
