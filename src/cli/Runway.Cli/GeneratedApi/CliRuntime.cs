...
internal static class CliRuntime
{
    ...
    public static async Task<global::Runway.RunwayClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Runway.ApiException exception)
    {
        var builder = new StringBuilder();
