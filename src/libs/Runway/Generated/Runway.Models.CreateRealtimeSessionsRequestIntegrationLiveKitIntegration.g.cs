...
namespace Runway
{
    ...
    public sealed partial class CreateRealtimeSessionsRequestIntegrationLiveKitIntegration
    {
        ...
        public string Type { get; set; } = "livekit";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRealtimeSessionsRequestIntegrationLiveKitIntegration" /> class.
        /// </summary>
        /// <param name="url">
        /// WebSocket URL of the external LiveKit server the avatar worker should join.
        /// </param>
...
#endif
        public CreateRealtimeSessionsRequestIntegrationLiveKitIntegration(
            string url,
            string token,
            string roomName,
