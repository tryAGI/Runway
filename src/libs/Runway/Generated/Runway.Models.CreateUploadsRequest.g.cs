...
namespace Runway
{
    ...
    public sealed partial class CreateUploadsRequest
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Runway.JsonConverters.CreateUploadsRequestTypeJsonConverter))]
        public global::Runway.CreateUploadsRequestType Type { get; set; }
        ...
        public CreateUploadsRequest(
            string filename,
            global::Runway.CreateUploadsRequestType type)
        {
