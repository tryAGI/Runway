...
namespace Runway
{
    ...
    public sealed partial class CreateGenerateVideoResponseRoutedVideoDryRunRoutingCapacityFallback
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGenerateVideoResponseRoutedVideoDryRunRoutingCapacityFallback" /> class.
        /// </summary>
        /// <param name="skipped">
        /// Eligible models that were considered for this request but not selected because this account is at its concurrency limit for them.
        /// </param>
...
#endif
        public CreateGenerateVideoResponseRoutedVideoDryRunRoutingCapacityFallback(
