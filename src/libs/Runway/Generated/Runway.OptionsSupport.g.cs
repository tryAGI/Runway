...
namespace Runway
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Runway.AutoSDKRetryOptions Retry { get; set; } = new global::Runway.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Runway.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Runway.IAutoSDKHook>();
        ...
        public global::Runway.AutoSDKClientOptions AddHook(
            global::Runway.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Runway.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Runway.AutoSDKClientOptions UseAuthorizationProvider(
            global::Runway.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Runway.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Runway.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Runway.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Runway.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Runway.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Runway.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Runway.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Runway.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Runway.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Runway.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Runway.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Runway.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Runway.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Runway.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Runway.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Runway.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Runway.AutoSDKClientOptions clientOptions,
            global::Runway.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Runway.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Runway.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Runway.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Runway.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Runway.IAutoSDKHook, global::Runway.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Runway.AutoSDKHookContext context)
        {
