...
namespace Runway
{
    ...
    public sealed partial class RequestVariant19
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Runway.JsonConverters.RequestVariant1TargetLangJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Runway.RequestVariant1TargetLang TargetLang { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestVariant19" /> class.
        /// </summary>
        /// <param name="audioUri">
        /// A HTTPS URL, Runway or data URI containing an encoded audio. See [our docs](/assets/inputs#audio) on audio inputs for more information.<br/>
        /// Example: https://example.com/audio.mp3
...
#endif
        public RequestVariant19(
            global::Runway.AnyOf<string, string, string> audioUri,
            global::Runway.RequestVariant1TargetLang targetLang,
            string model,
