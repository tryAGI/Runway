...
namespace Runway
{
    ...
    public sealed partial class CreateVideoToVideoRequestAleph2KeyframeVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateVideoToVideoRequestAleph2KeyframeVariant2" /> class.
        /// </summary>
        /// <param name="uri">
        /// A HTTPS URL, Runway or data URI containing an encoded image. See [our docs](/assets/inputs#images) on image inputs for more information.<br/>
        /// Example: https://example.com/image.jpg
...
#endif
        public CreateVideoToVideoRequestAleph2KeyframeVariant2(
            string uri,
            double at)
        {
            this.Uri = uri;
