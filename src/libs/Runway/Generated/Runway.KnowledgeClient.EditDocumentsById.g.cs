...
namespace Runway
{
    public partial class KnowledgeClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_EditDocumentsByIdSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_EditDocumentsByIdSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
            {                s_EditDocumentsByIdSecurityRequirement0,
            };
        partial void PrepareEditDocumentsByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref string xRunwayVersion,
            global::Runway.PatchDocumentsRequest request);
        partial void PrepareEditDocumentsByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            string xRunwayVersion,
            global::Runway.PatchDocumentsRequest request);
        partial void ProcessEditDocumentsByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// );
        /// </remarks>
        public async global::System.Threading.Tasks.Task EditDocumentsByIdAsync(
            global::System.Guid id,
        ...
        {
            await EditDocumentsByIdAsResponseAsync(
                id: id,
        ...
        /// );
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse> EditDocumentsByIdAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditDocumentsByIdArguments(
            ...
            var __authorizations = global::Runway.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditDocumentsByIdSecurityRequirements,
                operationName: "EditDocumentsByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditDocumentsByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Runway.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Runway.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editDocumentsById",
                                methodName: "EditDocumentsByIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditDocumentsByIdResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task EditDocumentsByIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Runway.PatchDocumentsRequest
            {
                Name = name,
                Content = content,
            };

            await EditDocumentsByIdAsync(
                id: id,
                xRunwayVersion: xRunwayVersion,
                request: __request,
                requestOptions: requestOptions,
