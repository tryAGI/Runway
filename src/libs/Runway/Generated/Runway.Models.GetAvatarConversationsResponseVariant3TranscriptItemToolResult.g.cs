...
namespace Runway
{
    ...
    public sealed partial class GetAvatarConversationsResponseVariant3TranscriptItemToolResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvatarConversationsResponseVariant3TranscriptItemToolResult" /> class.
        /// </summary>
        /// <param name="name">
        /// The name of the tool that returned a result.
        /// </param>
...
#endif
        public GetAvatarConversationsResponseVariant3TranscriptItemToolResult(
            string name,
            string? id,
