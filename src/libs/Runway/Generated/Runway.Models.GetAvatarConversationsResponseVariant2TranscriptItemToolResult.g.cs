...
namespace Runway
{
    ...
    public sealed partial class GetAvatarConversationsResponseVariant2TranscriptItemToolResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvatarConversationsResponseVariant2TranscriptItemToolResult" /> class.
        /// </summary>
        /// <param name="name">
        /// The name of the tool that returned a result.
        /// </param>
...
#endif
        public GetAvatarConversationsResponseVariant2TranscriptItemToolResult(
            string name,
            string? id,
