...
namespace Runway
{
    public partial class StartGeneratingClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_CreateImageToVideoSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_CreateImageToVideoSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
        ...
        /// console.log(task);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.CreateImageToVideoResponse> CreateImageToVideoAsync(
        ...
        /// console.log(task);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.CreateImageToVideoResponse>> CreateImageToVideoAsResponseAsync(
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Runway.CreateImageToVideoResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Runway.CreateImageToVideoResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Runway.ApiException<global::Runway.CreateImageToVideoResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Runway.CreateImageToVideoResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Runway.CreateImageToVideoResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Runway.ApiException<global::Runway.CreateImageToVideoResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.CreateImageToVideoResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.CreateImageToVideoResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.CreateImageToVideoResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Runway.CreateImageToVideoResponse> CreateImageToVideoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Runway.CreateImageToVideoRequest
            {
            };
