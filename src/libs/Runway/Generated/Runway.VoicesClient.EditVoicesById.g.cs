...
namespace Runway
{
    public partial class VoicesClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_EditVoicesByIdSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_EditVoicesByIdSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
            {                s_EditVoicesByIdSecurityRequirement0,
            };
        partial void PrepareEditVoicesByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref string xRunwayVersion,
            global::Runway.PatchVoicesRequest request);
        partial void PrepareEditVoicesByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            string xRunwayVersion,
            global::Runway.PatchVoicesRequest request);
        partial void ProcessEditVoicesByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditVoicesByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.PatchVoicesResponse> EditVoicesByIdAsync(
            global::System.Guid id,
        ...
        {
            var __response = await EditVoicesByIdAsResponseAsync(
                id: id,
        ...
        /// console.log(voice.name);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.PatchVoicesResponse>> EditVoicesByIdAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditVoicesByIdArguments(
            ...
            var __authorizations = global::Runway.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditVoicesByIdSecurityRequirements,
                operationName: "EditVoicesByIdAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Runway.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Runway.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editVoicesById",
                                methodName: "EditVoicesByIdAsync",
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditVoicesByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.PatchVoicesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.PatchVoicesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.PatchVoicesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Runway.PatchVoicesResponse> EditVoicesByIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Runway.PatchVoicesRequest
            {
                Name = name,
                Description = description,
            };

            return await EditVoicesByIdAsync(
                id: id,
                xRunwayVersion: xRunwayVersion,
                request: __request,
                requestOptions: requestOptions,
