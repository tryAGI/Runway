...
namespace Runway
{
    ...
    public sealed partial class CreateTextToImageRequestGptImage2ReferenceImage
    {
        ...
        /// <summary>
        /// A tag to identify the reference image. This may be used to reference the image in prompt text. Must be 3-16 characters, start with a letter, and use only letters, digits, and underscores (no hyphens or other punctuation).
        /// </summary>
