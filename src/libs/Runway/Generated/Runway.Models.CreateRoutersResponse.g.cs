...
namespace Runway
{
    ...
    public sealed partial class CreateRoutersResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Runway.CreateRoutersResponseSettings Settings { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRoutersResponse" /> class.
        /// </summary>
        /// <param name="id">
        /// The Model Router's primary key ID (UUID). Use it to manage this router via the API; use the slug to reference the router in generation requests.
        /// </param>
        ...
        public CreateRoutersResponse(
            ...
            string name,
            int version,
            global::Runway.CreateRoutersResponseSettings settings,
