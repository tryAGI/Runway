...
namespace Runway
{
    ...
    public sealed partial class CreateRecipesMarketingStockImageRequestReferenceImage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRecipesMarketingStockImageRequestReferenceImage" /> class.
        /// </summary>
        /// <param name="uri">
        /// A HTTPS URL, Runway or data URI containing an encoded image. See [our docs](/assets/inputs#images) on image inputs for more information.<br/>
        /// Example: https://example.com/image.jpg
...
#endif
        public CreateRecipesMarketingStockImageRequestReferenceImage(
            string uri)
        {
            this.Uri = uri;
        }
