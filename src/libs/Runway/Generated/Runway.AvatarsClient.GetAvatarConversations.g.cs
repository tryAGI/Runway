...
namespace Runway
{
    public partial class AvatarsClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_GetAvatarConversationsSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_GetAvatarConversationsSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
            {                s_GetAvatarConversationsSecurityRequirement0,
            };
        partial void PrepareGetAvatarConversationsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? cursor,
            ref int limit,
            ref global::System.Guid? avatar,
            ref global::System.DateTime? startDate,
            ref global::System.DateTime? endDate,
            ref string xRunwayVersion);
        partial void PrepareGetAvatarConversationsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? cursor,
            int limit,
            global::System.Guid? avatar,
            global::System.DateTime? startDate,
            global::System.DateTime? endDate,
            string xRunwayVersion);
        partial void ProcessGetAvatarConversationsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAvatarConversationsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// }
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.GetAvatarConversationsResponse> GetAvatarConversationsAsync(
            int limit,
        ...
        {
            var __response = await GetAvatarConversationsAsResponseAsync(
                limit: limit,
                cursor: cursor,
                avatar: avatar,
                startDate: startDate,
        ...
        /// }
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.GetAvatarConversationsResponse>> GetAvatarConversationsAsResponseAsync(
            int limit,
            string? cursor = default,
            global::System.Guid? avatar = default,
            global::System.DateTime? startDate = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAvatarConversationsArguments(
            ...
            var __authorizations = global::Runway.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAvatarConversationsSecurityRequirements,
                operationName: "GetAvatarConversationsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAvatarConversationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Runway.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Runway.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAvatarConversations",
                                methodName: "GetAvatarConversationsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAvatarConversationsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAvatarConversationsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.GetAvatarConversationsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.GetAvatarConversationsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.GetAvatarConversationsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
