...
namespace Runway
{
    public partial class VoicesClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_CreateVoicesPreviewSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_CreateVoicesPreviewSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
            {                s_CreateVoicesPreviewSecurityRequirement0,
            };
        partial void PrepareCreateVoicesPreviewArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xRunwayVersion,
            global::Runway.CreateVoicesPreviewRequest request);
        partial void PrepareCreateVoicesPreviewRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xRunwayVersion,
            global::Runway.CreateVoicesPreviewRequest request);
        partial void ProcessCreateVoicesPreviewResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVoicesPreviewResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.CreateVoicesPreviewResponse> CreateVoicesPreviewAsync(
        ...
        {
            var __response = await CreateVoicesPreviewAsResponseAsync(
        ...
        /// console.log(preview.url, preview.durationSecs);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.CreateVoicesPreviewResponse>> CreateVoicesPreviewAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVoicesPreviewArguments(
            ...
            var __authorizations = global::Runway.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVoicesPreviewSecurityRequirements,
                operationName: "CreateVoicesPreviewAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVoicesPreviewRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Runway.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Runway.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVoicesPreview",
                                methodName: "CreateVoicesPreviewAsync",
                                pathTemplate: "\"/v1/voices/preview\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVoicesPreviewResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVoicesPreviewResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.CreateVoicesPreviewResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.CreateVoicesPreviewResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.CreateVoicesPreviewResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Runway.CreateVoicesPreviewResponse> CreateVoicesPreviewAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Runway.CreateVoicesPreviewRequest
            {
                Prompt = prompt,
                Model = model,
            };

            return await CreateVoicesPreviewAsync(
                xRunwayVersion: xRunwayVersion,
                request: __request,
                requestOptions: requestOptions,
