...
namespace Runway
{
    public partial class StartGeneratingClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_CreateTextToVideoSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_CreateTextToVideoSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
        ...
        /// console.log(task);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.CreateTextToVideoResponse> CreateTextToVideoAsync(
        ...
        /// console.log(task);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.CreateTextToVideoResponse>> CreateTextToVideoAsResponseAsync(
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Runway.CreateTextToVideoResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Runway.CreateTextToVideoResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Runway.ApiException<global::Runway.CreateTextToVideoResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Runway.CreateTextToVideoResponse3? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Runway.CreateTextToVideoResponse3.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Runway.ApiException<global::Runway.CreateTextToVideoResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.CreateTextToVideoResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.CreateTextToVideoResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.CreateTextToVideoResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Runway.CreateTextToVideoResponse> CreateTextToVideoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Runway.CreateTextToVideoRequest
            {
            };
