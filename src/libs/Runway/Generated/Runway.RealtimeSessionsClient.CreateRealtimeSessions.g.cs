...
namespace Runway
{
    public partial class RealtimeSessionsClient
    {


        private static readonly global::Runway.EndPointSecurityRequirement s_CreateRealtimeSessionsSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_CreateRealtimeSessionsSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
            {                s_CreateRealtimeSessionsSecurityRequirement0,
            };
        partial void PrepareCreateRealtimeSessionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xRunwayVersion,
            global::Runway.CreateRealtimeSessionsRequest request);
        partial void PrepareCreateRealtimeSessionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xRunwayVersion,
            global::Runway.CreateRealtimeSessionsRequest request);
        partial void ProcessCreateRealtimeSessionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateRealtimeSessionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.CreateRealtimeSessionsResponse> CreateRealtimeSessionsAsync(
        ...
        {
            var __response = await CreateRealtimeSessionsAsResponseAsync(
        ...
        /// console.log(session.id);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.CreateRealtimeSessionsResponse>> CreateRealtimeSessionsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateRealtimeSessionsArguments(
            ...
            var __authorizations = global::Runway.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateRealtimeSessionsSecurityRequirements,
                operationName: "CreateRealtimeSessionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateRealtimeSessionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Runway.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Runway.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createRealtimeSessions",
                                methodName: "CreateRealtimeSessionsAsync",
                                pathTemplate: "\"/v1/realtime_sessions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateRealtimeSessionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateRealtimeSessionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.CreateRealtimeSessionsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.CreateRealtimeSessionsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.CreateRealtimeSessionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Runway.CreateRealtimeSessionsResponse> CreateRealtimeSessionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Runway.CreateRealtimeSessionsRequest
            {
                Model = model,
                Avatar = avatar,
            ...
            return await CreateRealtimeSessionsAsync(
                xRunwayVersion: xRunwayVersion,
                request: __request,
                requestOptions: requestOptions,
