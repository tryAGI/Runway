...
namespace Runway
{
    ...
    public sealed partial class Request12
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Runway.JsonConverters.RequestTypeJsonConverter))]
        public global::Runway.RequestType Type { get; set; }
        ...
        public Request12(
            string filename,
            global::Runway.RequestType type)
        {
