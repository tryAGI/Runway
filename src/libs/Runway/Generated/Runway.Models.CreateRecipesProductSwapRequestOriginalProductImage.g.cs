...
namespace Runway
{
    ...
    public sealed partial class CreateRecipesProductSwapRequestOriginalProductImage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRecipesProductSwapRequestOriginalProductImage" /> class.
        /// </summary>
        /// <param name="uri">
        /// A HTTPS URL, Runway or data URI containing an encoded image. See [our docs](/assets/inputs#images) on image inputs for more information.<br/>
        /// Example: https://example.com/image.jpg
...
#endif
        public CreateRecipesProductSwapRequestOriginalProductImage(
            string uri)
        {
            this.Uri = uri;
        }
