...
namespace Runway
{
    ...
    public sealed partial class CreateGenerateImageResponseRoutedImageDryRunRoutingResolvedInput
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGenerateImageResponseRoutedImageDryRunRoutingResolvedInput" /> class.
        /// </summary>
        /// <param name="ratio">
        /// Concrete output ratio derived from aspectRatio and resolution for the selected model.
        /// </param>
...
#endif
        public CreateGenerateImageResponseRoutedImageDryRunRoutingResolvedInput(
            string ratio,
            string aspectRatio,
            string resolution)
        {
