...
namespace Runway
{
    public partial class ModelRouterClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_EditRoutersByIdSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_EditRoutersByIdSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
            {                s_EditRoutersByIdSecurityRequirement0,
            };
        partial void PrepareEditRoutersByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref string xRunwayVersion,
            global::Runway.PatchRoutersRequest request);
        partial void PrepareEditRoutersByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            string xRunwayVersion,
            global::Runway.PatchRoutersRequest request);
        partial void ProcessEditRoutersByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditRoutersByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Runway.PatchRoutersResponse> EditRoutersByIdAsync(
            global::System.Guid id,
        ...
        {
            var __response = await EditRoutersByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Runway.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.PatchRoutersResponse>> EditRoutersByIdAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditRoutersByIdArguments(
            ...
            var __authorizations = global::Runway.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditRoutersByIdSecurityRequirements,
                operationName: "EditRoutersByIdAsync");
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditRoutersByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditRoutersByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.PatchRoutersResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.PatchRoutersResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.PatchRoutersResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Runway.PatchRoutersResponse> EditRoutersByIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Runway.PatchRoutersRequest
            {
                Name = name,
            ...
            return await EditRoutersByIdAsync(
                id: id,
                xRunwayVersion: xRunwayVersion,
                request: __request,
                requestOptions: requestOptions,
