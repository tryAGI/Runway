...
namespace Runway
{
    ...
    public sealed partial class GetRoutersResponseDataItem
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Runway.GetRoutersResponseDataItemSettings Settings { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRoutersResponseDataItem" /> class.
        /// </summary>
        /// <param name="id">
        /// The Model Router's primary key ID (UUID). Use it to manage this router via the API; use the slug to reference the router in generation requests.
        /// </param>
...
#endif
        public GetRoutersResponseDataItem(
            global::System.Guid id,
            string slug,
            string name,
            int version,
            global::Runway.GetRoutersResponseDataItemSettings settings,
