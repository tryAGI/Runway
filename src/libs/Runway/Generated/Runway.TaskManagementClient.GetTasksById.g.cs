...
namespace Runway
{
    public partial class TaskManagementClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_GetTasksByIdSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_GetTasksByIdSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
        ...
        ///   .waitForTaskOutput();
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.GetTasksResponse> GetTasksByIdAsync(
            global::System.Guid id,
        ...
        ///   .waitForTaskOutput();
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.GetTasksResponse>> GetTasksByIdAsResponseAsync(
            global::System.Guid id,
            string xRunwayVersion = "2024-11-06",
            global::Runway.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Runway.GetTasksResponse2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Runway.GetTasksResponse2.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Runway.ApiException<global::Runway.GetTasksResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.GetTasksResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.GetTasksResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.GetTasksResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
