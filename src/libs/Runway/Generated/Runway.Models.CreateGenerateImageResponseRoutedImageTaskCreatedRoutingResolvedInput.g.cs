...
namespace Runway
{
    ...
    public sealed partial class CreateGenerateImageResponseRoutedImageTaskCreatedRoutingResolvedInput
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGenerateImageResponseRoutedImageTaskCreatedRoutingResolvedInput" /> class.
        /// </summary>
        /// <param name="ratio">
        /// Concrete output ratio derived from aspectRatio and resolution for the selected model.
        /// </param>
...
#endif
        public CreateGenerateImageResponseRoutedImageTaskCreatedRoutingResolvedInput(
            string ratio,
            string aspectRatio,
            string resolution)
        {
