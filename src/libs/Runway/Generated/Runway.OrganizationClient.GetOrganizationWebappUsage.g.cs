...
namespace Runway
{
    public partial class OrganizationClient
    {
        ...
        private static readonly global::Runway.EndPointSecurityRequirement s_GetOrganizationWebappUsageSecurityRequirement0 =
        ...
        private static readonly global::Runway.EndPointSecurityRequirement[] s_GetOrganizationWebappUsageSecurityRequirements =
            new global::Runway.EndPointSecurityRequirement[]
            {                s_GetOrganizationWebappUsageSecurityRequirement0,
            };
        partial void PrepareGetOrganizationWebappUsageArguments(
        ...
        partial void PrepareGetOrganizationWebappUsageRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetOrganizationWebappUsageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetOrganizationWebappUsageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Runway.GetOrganizationWebappUsageResponse> GetOrganizationWebappUsageAsync(
            int limit,
            global::System.DateTime from,
            global::System.DateTime to,
        ...
        {
            var __response = await GetOrganizationWebappUsageAsResponseAsync(
                limit: limit,
                from: from,
                to: to,
                cursor: cursor,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Runway.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Runway.AutoSDKHttpResponse<global::Runway.GetOrganizationWebappUsageResponse>> GetOrganizationWebappUsageAsResponseAsync(
            int limit,
            global::System.DateTime from,
            global::System.DateTime to,
            string? cursor = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetOrganizationWebappUsageArguments(
            ...
            var __authorizations = global::Runway.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetOrganizationWebappUsageSecurityRequirements,
                operationName: "GetOrganizationWebappUsageAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetOrganizationWebappUsageRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Runway.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Runway.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getOrganizationWebappUsage",
                                methodName: "GetOrganizationWebappUsageAsync",
                                pathTemplate: "\"/v1/organization/webapp/usage\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetOrganizationWebappUsageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Runway.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetOrganizationWebappUsageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Runway.GetOrganizationWebappUsageResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Runway.AutoSDKHttpResponse<global::Runway.GetOrganizationWebappUsageResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Runway.GetOrganizationWebappUsageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
